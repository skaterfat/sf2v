...
if ($isFilter || $isSidebar): ?>
	<div class="col-md-3 col-sm-3 <?=(isset($arParams['FILTER_HIDE_ON_MOBILE']) && $arParams['FILTER_HIDE_ON_MOBILE'] === 'Y' ? ' hidden-xs' : '')?>">
...
<?endif?>
<div class="<?=(($isFilter || $isSidebar) ? "col-md-9 col-sm-9" : "col-xs-12")?>">
	<div class="row">
		<div class="col-xs-12">
			<?
