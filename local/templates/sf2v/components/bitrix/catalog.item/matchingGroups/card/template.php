...
if (empty($item['PREVIEW_PICTURE']['SRC'])) {
    $item['PREVIEW_PICTURE']['SRC'] = '/local/templates/sf2v/components/bitrix/catalog.section/theseGoodsBuy/images/no_photo.png';
}

?>

<div class="col-sm-4 section-main-page-item">
    <a
            class="section-main-page-img"
            style="background: url(<?=$item['PREVIEW_PICTURE']['SRC']?>?2) center center no-repeat;background-size: 100%;"
