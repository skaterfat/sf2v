...
$APPLICATION->SetPageProperty("keywords", "Подшипники, подшипники в Москве, подшипники Клин, подшипники Ярославль, приводные ремни, сальники, манжеты, манжета, сальник");
$APPLICATION->SetPageProperty("description", "В каталоге интернет-магазина Сфера-2В представлены свыше 100 000 подшипников, ремней, сальников, смазок мировых и отечественных производителей, и сопутствующих товаров. Цены на  подшипники, сальники и ремни указаны на страницах разделов.");
$APPLICATION->SetTitle("Каталог товаров: подшипники, сальники, ремни, смазка");
?>
<?
global $arCatalogSectionFilter;

$arCatalogSectionFilter = [];

if (isset($_REQUEST['CATALOG_SIDE_BAR'])) {
    $_SESSION['SHOW_GOODS_ON_ORDER'] = $_REQUEST['SHOW_GOODS_ON_ORDER'];
}

if ($_SESSION['SHOW_GOODS_ON_ORDER'] != 1) {
    $arCatalogSectionFilter = [
        '>CATALOG_QUANTITY' => 0,
    ];
}
...
<?$APPLICATION->IncludeComponent("bitrix:catalog", ".default", Array(
	"IBLOCK_TYPE" => "catalog",	// Тип инфоблока
		...
		"FILTER_NAME" => "arCatalogSectionFilter",	// Фильтр
		...
		"ELEMENT_SORT_FIELD" => $arSort['ELEMENT_SORT_FIELD'],	// По какому полю сортируем товары в разделе
		"ELEMENT_SORT_ORDER" => $arSort['ELEMENT_SORT_ORDER'],	// Порядок сортировки товаров в разделе
